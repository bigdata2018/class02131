...
import atguigu.bigdata.spark.core.req.bean
import atguigu.bigdata.spark.core.req.bean.HotCategory
import atguigu.bigdata.spark.core.req.dao.HotCategorySessionAnalysisTop10Dao
